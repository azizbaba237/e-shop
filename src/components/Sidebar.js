...
const Sidebar = () => {
  ...
  return (
    <div
      ...
      } w-full bg-white fixed top-0 h-full shadow-2xl md:w-[35vw] xl:max-x-[30vw] transition-all duration-300 z-20 px-4 lg:px-[35px]`}
    >
      {" "}
      <div className="flex items-center justify-between py-6 border-b">
        <div className="uppercase text-sm font-semibold text-white">
          {" "}
          Sopping Bag ({itemAmount}){" "}
        </div>
        {/* icon */}
        <div
          onClick={handleClose}
      ...
      <div className="flex flex-col gap-y-2 h-[520px] lg:h-[640px] overflow-y-auto overflow-hiden">
        {cart.map((item) => {
      ...
      <div className=" flex flex-col gap-y-3 py-2 mt-4 ">
        <div className="flex w-full justify-between items-center ">
          {/* total  */}
          <div className="uppercase font-sembold">
